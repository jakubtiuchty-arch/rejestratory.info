...
| 2026-09-14 | **Smartfony Samsung Galaxy** (wiodący XCover7) | /kategoria/telefony | PRZYGOTOWANE 09.09 — `editions/2026-09-15-samsung-galaxy.html`, manifest wskazuje, bulk pon.→wt. **15.09 8:30** po zatwierdzeniu testówki |
| 2026-09-21 | **Laptopy HP EliteBook** (wiodący 6 G1ah 16", obok 14" ze Smart Card i stacja HP Dock G6) | /kategoria/laptopy | ZAPLANOWANE ręcznie 13.09 — **611 maili na wtorek 22.09 8:30**, ID w `scheduled-2026-09-22.json`. Rezerwacja w `newsletter_sends` blokuje poniedziałkowy przycisk — **nie zatwierdzać testówki**, wysyłka jest już w Resend. Anulowanie: `resend.emails.cancel(id)` do godziny wysyłki. |
