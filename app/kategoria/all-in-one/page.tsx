...
// Produkty dla kategorii All in One
const products = [
  {
    id: 1,
    name: "AIO HP ProOne 440 G9 23,8''",
    category: "All in One",
    description: "Komputer All-in-One HP z ekranem dotykowym 23,8 cala do biura",
    specifications: "23,8\" FHD dotykowy, Intel Core i5, 8GB RAM, 256GB SSD, Windows 11 Pro",
    price: "4 500 PLN",
  ...
  },
  {
    ...
    category: "All in One", 
    description: "Elegancki komputer All-in-One Dell do zastosowań biurowych",
    specifications: "24\" FHD IPS, Intel Core i5, 8GB RAM, 512GB SSD, Windows 11 Pro",
    price: "5 200 PLN",
    availability: "Dostępny",
    whereToBuy: "ZUP Łódź",
    image: "/api/placeholder/300/300",
      ...
      <section className="bg-white py-8">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-700 max-w-3xl">
            Kompaktowe komputery All-in-One dostosowane do potrzeb pracowników leśnictwa. 
            Wysokiej jakości urządzenia łączące komputer i monitor w jednej obudowie do pracy biurowej.
          </p>
        </div>
      </section>
