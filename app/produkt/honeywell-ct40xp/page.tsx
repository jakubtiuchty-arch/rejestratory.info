          ...
          >
            ...
            >
              <img
                ...
                alt="Honeywell CT40XP - powiększenie"
...
const Specifications = () => {
  const specs = [
    { category: "Wyświetlacz", items: [
      { name: "Rozmiar", value: "Ekran 5,0''" },
      { name: "Rozdzielczość", value: "1920 x 1080 Full HD" },
    ]},
    { category: "Wydajność", items: [
      { name: "Procesor", value: "2,2 GHz Qualcomm Snapdragon 660 Octa-Core" },
      { name: "RAM", value: "4GB" },
      { name: "Pamięć", value: "32 GB Flash" }
    ]},
    ...
    { category: "Bateria", items: [
      { name: "Pojemność", value: "4020 mAh" },
      { name: "Czas pracy", value: "12+ godzin" },
...
const AccessoriesSection = ({ productName }: { productName: string }) => {
  ...
  const accessories = [
    ...
    {
      id: 'dock-usb',
      name: 'Stacja dokująca do ładowania urządzenia z portami USB + zasilacz + kabel USB',
      description: 'Kompletna stacja dokująca z portami USB'
    },
    {
      id: 'dock-ethernet',
      name: 'Stacja dokująca do ładowania urządzenia z portami USB + Ethernet + zasilacz + kabel USB',
      description: 'Stacja dokująca z USB i Ethernet'
    },
    {
      id: 'battery-standard',
      name: 'Akumulator 4020mAh',
      description: 'Standardowy akumulator zapasowy'
    },
    {
      id: 'battery-extended',
      name: 'Akumulator o zwiększonej pojemności min. 6600 mAh',
  ...
  const handleAddSelectedAccessories = () => {
    selectedAccessories.forEach(accessoryId => {
      ...
      if (accessory) {
        addToInquiry({
          id: `ct40xp-accessory-${accessory.id}`,
...
export default function HoneywellCT40XPProductPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900">Honeywell CT40XP</span>
        </nav>
      </div>
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-justify">
                Honeywell CT40XP to wytrzymały komputer mobilny do pracy leśnika w terenie. 5,0'' ekran Full HD czytelny w słońcu, wzmocniony szkłem Gorilla Glass, ułatwia przegląd map i zdjęć. Skaner 2D szybko odczytuje plakietki i kody na dokumentach przewozowych, a łączność Wi-Fi i opcjonalne LTE pozwalają przekazywać dane prosto z ostępów. Snapdragon 660 2,2 GHz i 4 GB RAM zapewniają płynność formularzy i aplikacji pomiarowych. Obudowa z klasą IP67 chroni przed deszczem, błotem i kurzem, więc urządzenie znosi pracę w rękawicach i zmienne temperatury. Bateria 4020 mAh wystarcza na cały dzień. Platforma Mobility Edge upraszcza aktualizacje i bezpieczeństwo floty. USB-C przyspiesza ładowanie, NFC ułatwia parowanie akcesoriów, a precyzyjny GPS wspiera orientację w oddziałach. Szybciej.
              </p>
                ...
                <motion.button
                  onClick={() => {
                    addToInquiry({
                      ...
                      description: 'Wytrzymały komputer mobilny do pracy leśnika w terenie',
                      specifications: '5,0" Full HD, Snapdragon 660, 4GB RAM, IP67'
                    })
                    setShowRipple(true)
        ...
        {/* Accessories Section */}
        <AccessoriesSection productName="Honeywell CT40XP" />
      ...
      <CourierServiceSection productName="Honeywell CT40XP" />
{/* Footer */}
<Footer />
</div>
  )
