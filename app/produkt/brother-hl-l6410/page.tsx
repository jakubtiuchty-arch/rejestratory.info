        ...
        {isZoomed && (
          ...
          >
            ...
            >
              <img
                src="/HLL6410DN_1.png"
                alt="Brother HL-L6410 - powiększenie"
...
const Specifications = () => {
  const specs = [
    { category: "Ogólne", items: [
      ...
      { name: "Połączenie", value: "USB 2.0, Gigabit Ethernet, Wi-Fi (opcjonalnie)" },
      { name: "Panel sterowania", value: "Kolorowy ekran dotykowy 8,9 cm" },
      { name: "Pamięć", value: "1 GB" }
    ]},
    ...
    { category: "Materiały eksploatacyjne", items: [
      { name: "Toner startowy", value: "11000 stron" },
      { name: "Tonery zamienne", value: "TN3600 (3000), TN3600XL (6000), TN3600XXL (11000), TN3610 (18000), TN3610XL (25000 stron)" },
          ...
          >
            <div className="p-6">
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Urządzenia konsumenckie, takie jak Brother HL-L6410, nie są objęte 
...
const AccessoriesSection = ({ productName, onAddToInquiry }: { productName: string, onAddToInquiry: () => void }) => {
  ...
  const accessories = [
    ...
    {
      id: 'toner-25000',
      name: 'Toner czarny Brother TN3610XL',
      description: 'Oryginalny toner Brother, wydajność 25000 stron',
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900">Brother HL-L6410</span>
        </nav>
      </div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-justify">
                Brother HL-L6410 to zaawansowana monochromatyczna drukarka laserowa zaprojektowana z myślą o wymagających środowiskach biurowych i instytucjach publicznych. Wyposażona w kolorowy ekran dotykowy o przekątnej 8,9 cm oraz pamięć 1 GB, oferuje intuicyjną obsługę i wydajną pracę. Urządzenie cechuje się dużym cyklem pracy do 16 000 stron miesięcznie oraz wsparciem dla technologii NFC umożliwiającej bezprzewodowy druk z urządzeń mobilnych. Automatyczne drukowanie dwustronne oraz rozbudowane funkcje bezpieczeństwa sprawiają, że jest to idealne rozwiązanie dla nadleśnictw wymagających niezawodności i profesjonalnego wsparcia.
              </p>
              ...
              {/* TONER STARTOWY 11000 - INFO BOX - RZUCAJĄCY SIĘ W OKY GRADIENT */}
              <div className="rounded-lg p-4 border-2 mb-6 shadow-md" style={{ background: 'linear-gradient(to right, #ff6b35, #f7931e, #feca57)', borderColor: '#ff6b35' }}>
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold mb-1 text-white">Toner startowy na 11000 stron w zestawie!</h4>
                    <p className="text-sm text-white">
                      Brother HL-L6410 jest dostarczany z wyjątkowo wydajnym tonerem startowym o pojemności aż 11000 stron! 
                      To znacznie dłuższy okres pracy bez konieczności zakupu materiałów eksploatacyjnych, co czyni to urządzenie 
                      niezwykle ekonomicznym wyborem dla nadleśnictw. Rozpocznij intensywne drukowanie od razu po rozpakowaniu.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <CourierServiceSection productName="Brother HL-L6410" />
