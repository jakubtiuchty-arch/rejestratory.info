...
const Specifications = () => {
  const specs = [
    { category: "Wyświetlacz", items: [
      ...
      { name: "Rozdzielczość", value: "2340 x 1080 FHD+ Dynamic AMOLED 2X" },
      { name: "Odświeżanie", value: "120 Hz" },
      { name: "Jasność szczytowa", value: "Vision Booster" },
    ]},
    { category: "Wydajność", items: [
      { name: "Procesor", value: "Exynos 2400 z AI" },
      { name: "RAM", value: "8 GB" },
      { name: "Pamięć", value: "128 GB" },
      { name: "System", value: "Android 16, One UI 8" }
    ]},
    { category: "Wytrzymałość", items: [
      { name: "Norma", value: "IP68 - pyłoszczelny i wodoodporny" },
      { name: "Szkło", value: "Corning Gorilla Glass Victus+" },
      { name: "Ramka", value: "Armor Aluminum" },
      { name: "Wymiary", value: "7.4 mm grubości, 190 g" }
    ]},
    { category: "Bateria", items: [
      { name: "Pojemność", value: "4900 mAh" },
      { name: "Ładowanie przewodowe", value: "USB-C, 45W (65% w 30 min)" },
      { name: "Ładowanie bezprzewodowe", value: "15W" }
    ]},
    { category: "Aparat", items: [
      { name: "Główny", value: "50 MP, OIS" },
      { name: "Ultraszeroki", value: "12 MP" },
      { name: "Teleobiektyw", value: "8 MP, zoom optyczny 3x" },
      { name: "Przedni", value: "12 MP" }
    ]}
  ]
          ...
          >
            <div className="p-6">
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Urządzenia konsumenckie, takie jak Samsung Galaxy S25 FE, nie są objęte
...
const AccessoriesSection = ({ productName }: { productName: string }) => {
  ...
  const accessories = [
    ...
    },
    {
      id: 'case',
      name: 'Etui ochronne',
      description: 'Premium etui z wzmocnionymi rogami',
      price: '59 zł'
    },
    {
      id: 'glass',
  ...
  const handleAddSelectedToInquiry = () => {
    selectedAccessories.forEach(accessoryId => {
      ...
      if (accessory) {
        addToInquiry({
          id: `samsung-s25fe-accessory-${accessory.id}`,
          name: accessory.name,
...
export default function SamsungS25FEProductPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900">Samsung S25 FE</span>
        </nav>
      </div>
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-justify">
                Samsung Galaxy S25 FE (Fan Edition) to smartfon łączący flagowe funkcje serii S25 w bardziej przystępnej cenie. Wyposażony w 6,7-calowy wyświetlacz Dynamic AMOLED 2X o rozdzielczości FHD+ z odświeżaniem 120 Hz oraz procesor Exynos 2400 z AI zapewnia płynne działanie aplikacji administracji leśnej. Aparat 50 MP z optyczną stabilizacją obrazu oraz teleobiektyw z 3-krotnym zoomem optycznym umożliwiają dokumentację terenową w wysokiej jakości. Bateria 4900 mAh z szybkim ładowaniem 45W (65% w 30 minut) gwarantuje całodzienny czas pracy. Certyfikat IP68, szkło Corning Gorilla Glass Victus+ oraz ramka Armor Aluminum zapewniają ochronę przed wodą, pyłem i upadkami. System Android 16 z One UI 8 i gwarancją 7 lat aktualizacji. Przy wadze zaledwie 190 g i grubości 7,4 mm jest najsmuklejszym modelem FE w historii. Brak dedykowanego skanera kodów 2D wymaga dodatkowych rozwiązań programowych. Jako urządzenie konsumenckie nie jest objęte kontraktami serwisowymi, co może generować wyższe koszty całkowite w porównaniu ze sprzętem przemysłowym dedykowanym do pracy terenowej.
              </p>
                ...
                <motion.button
                  onClick={() => {
                    addToInquiry({
                      ...
                      specifications: '6.7" FHD+ Dynamic AMOLED 2X 120Hz, Exynos 2400, 8GB RAM, 4900 mAh, IP68'
                    })
                    setShowRipple(true)
        ...
        {/* Accessories Section */}
        <AccessoriesSection productName="Samsung Galaxy S25 FE" />
        ...
        <div className="mb-16">
          <AnimatePresence mode="wait">
            ...
            {activeTab === 'downloads' && (
              ...
              >
                {[
                  { title: "Karta katalogowa", type: "PDF", size: "1.6 MB" },
                  { title: "Instrukcja obsługi", type: "PDF", size: "3.8 MB" },
      ...
      <CourierServiceSection productName="Samsung Galaxy S25 FE" />
