          ...
          >
            <div className="p-6">
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Urządzenia konsumenckie, takie jak Samsung Galaxy S25 Plus, nie są objęte 
...
const AccessoriesSection = ({ productName }: { productName: string }) => {
  ...
  const handleAddSelectedToInquiry = () => {
    selectedAccessories.forEach(accessoryId => {
      ...
      if (accessory) {
        addToInquiry({
          id: `samsung-s25plus-accessory-${accessory.id}`,
          name: accessory.name,
...
export default function SamsungS25PlusProductPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900">Samsung S25 Plus</span>
        </nav>
      </div>
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-justify">
                Samsung Galaxy S25 Plus to flagowy smartfon konsumencki z wyższej półki cenowej, oferujący zaawansowane parametry techniczne dla użytkowników oczekujących wysokiej wydajności. Wyświetlacz Dynamic AMOLED 2X o rozdzielczości QHD+ oraz procesor najnowszej generacji zapewniają płynność działania przy standardowych zastosowaniach biurowych i mobilnych. System Android z aktualizacjami zabezpieczeń umożliwia instalację aplikacji administracji leśnej. Certyfikat IP68 oraz wzmocnione szkło Gorilla Glass Victus 2 zapewniają ochronę przed uszkodzeniami w codziennym użytkowaniu, jednak urządzenie nie jest projektowane do intensywnej eksploatacji w ekstremalnych warunkach terenowych. Brak dedykowanego skanera kodów 2D wymaga dodatkowych rozwiązań programowych. Wysoka cena nabycia i brak kontraktów serwisowych dla urządzeń konsumenckich mogą generować wyższe koszty całkowite w porównaniu ze sprzętem przemysłowym dedykowanym do pracy terenowej.
              </p>
                ...
                <motion.button
                  onClick={() => {
                    addToInquiry({
                      ...
                      image: '/s25plus_1.png',
                      category: 'Telefony',
                      description: 'Flagowy smartfon konsumencki z wyższej półki cenowej',
                      specifications: '6.7" QHD+ Dynamic AMOLED 2X, Snapdragon 8 Elite, 12GB RAM, IP68'
                    })
                    setShowRipple(true)
        ...
        {/* Accessories Section */}
        <AccessoriesSection productName="Samsung Galaxy S25 Plus" />
      ...
      <CourierServiceSection productName="Samsung Galaxy S25 Plus" />
