...
${courierFormData.faultDescription}
  ...
  const DEMO_NUMBER = 'PTM-2024-001234'
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="np. PTM-2024-001234"
              ...
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                <p className="text-sm text-blue-900">
                  <strong>Demo:</strong> Użyj numeru <code className="bg-white px-2 py-1 rounded font-mono text-xs">PTM-2024-001234</code> aby zobaczyć przykładowy dashboard
                </p>
              </div>
            </div>
          </motion.div>
