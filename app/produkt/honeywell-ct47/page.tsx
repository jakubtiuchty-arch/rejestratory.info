        ...
        {isZoomed && (
          ...
          >
            ...
            >
              <img
                src="/ct47_1.png"
                alt="Honeywell CT47 - powiększenie"
...
const Specifications = () => {
  const specs = [
    { category: "Wyświetlacz", items: [
      ...
      { name: "Rozdzielczość", value: "2160 x 1080 Full HD" },
    ]},
    { category: "Wydajność", items: [
      { name: "Procesor", value: "Qualcomm QCM6490 Octa-Core 2,7 GHz" },
      { name: "RAM", value: "6GB" },
      { name: "Pamięć", value: "128 GB Flash" }
    ]},
    { category: "Wytrzymałość", items: [
      { name: "Norma", value: "IP65/IP68" },
      { name: "Upadki", value: "Wytrzymuje upadki w terenie" },
      { name: "Temperatura", value: "-20°C do +50°C" }
    ]},
    { category: "Bateria", items: [
      { name: "Pojemność", value: "4775 mAh" },
      { name: "Czas pracy", value: "14+ godzin" },
...
const AccessoriesSection = ({ productName }: { productName: string }) => {
  ...
  const handleAddSelectedToInquiry = () => {
    selectedAccessories.forEach(accessoryId => {
      ...
      if (accessory) {
        addToInquiry({
          id: `ct47-accessory-${accessory.id}`,
          name: accessory.name,
          image: '/ct47_1.png',
          category: 'Akcesoria',
...
export default function HoneywellCT47ProductPage() {
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <nav className="flex items-center justify-between h-16">
            <div className="flex items-center gap-2">
              <img src="/rejestratory_logo_footer_header.pngrejestratory_logo.png" alt="Rejestartory.info" className="h-8 w-auto" />
            </div>
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900">Honeywell CT47</span>
        </nav>
      </div>
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-justify">
                Honeywell CT47 to ultra-wytrzymały komputer mobilny do pracy w lesie. 5,5'' ekran Full HD z Gorilla Glass 5 jest czytelny w słońcu i odporny na zarysowania, a szybki skaner 2D usprawnia odczyt plakietek oraz kodów na kartach przewozowych. Ośmiordzeniowy Snapdragon QCM6490 2,7 GHz i 6 GB RAM zapewniają płynność map, zdjęć i formularzy. Obudowa z klasą IP65/IP68 wytrzymuje deszcz, błoto i pył, a wzmocniona konstrukcja znosi upadki w terenie. Bateria 4775 mAh wystarcza na 14+ godzin pracy. Łączność 5G i Wi-Fi 6E gwarantuje szybkie wysyłanie danych i stabilne połączenia nawet przy słabym zasięgu. USB-C ułatwia szybkie ładowanie oraz podłączanie akcesoriów, a dokładny GPS ułatwia orientację w oddziałach i kwaterach. Ergonomia i tryb w rękawicach zwiększają wygodę pracy. Dziś
              </p>
                ...
                <motion.button
                  onClick={() => {
                    addToInquiry({
                      ...
                      description: 'Ultra-wytrzymały komputer mobilny do pracy w lesie',
                      specifications: '5.5" Full HD, Snapdragon QCM6490, 6GB RAM, IP65/IP68'
                    })
                    setShowRipple(true)
        ...
        {/* Accessories Section */}
        <AccessoriesSection productName="Honeywell CT47" />
            ...
            {activeTab === 'downloads' && (
              ...
              >
                {[
                  ...
                  { title: "Certyfikaty IP65/IP68", type: "PDF", size: "0.9 MB" },
