...
const Specifications = () => {
  const specs = [
    { category: "Ogólne", items: [
      ...
      { name: "Wymiary", value: "156 x 152 x 71 mm" },
      { name: "Waga", value: "Około 760 g" },
      { name: "Certyfikaty", value: "FCC, CE, VCCI" },
      { name: "Żywotność serwisowa", value: "50 km" }
    ]},
    { category: "Drukowanie", items: [
      { name: "Metoda druku", value: "Thermal line dot printing" },
      { name: "Prędkość druku", value: "Do 105 mm/s" },
    ...
    { category: "Obsługa papieru", items: [
      { name: "Rodzaje nośników", value: "Papier w rolce, etykiety w rolce" },
      { name: "Szerokość papieru", value: "80/100/105/112 mm" },
      { name: "Maksymalna średnica rolki", value: "Ø 58 mm" },
      { name: "Obcięcie papieru", value: "Tear bar" }
    ]},
    { category: "Bateria i zasilanie", items: [
      { name: "Zasilanie", value: "Adapter AC (opcja), bateria Li-Ion" },
      { name: "Bufor wejściowy", value: "4k bytes" }
    ]},
    { category: "Łączność", items: [
      { name: "Interfejs komunikacji", value: "USB, Bluetooth" },
      { name: "Polecenia", value: "ESC/POS, CPCL, Markup Language" },
      { name: "Wsparcie platform", value: "Windows CE, Android, iOS" }
    ]},
    { category: "Odporność", items: [
      { name: "Szczelność", value: "IP54" },
      { name: "Odporność na upadki", value: "2,0 m (wielokrotnie)" },
      { name: "Temperatura robocza", value: "-20°C do 50°C" }
    ]}
  ]
...
const AccessoriesSection = ({ productName }: { productName: string }) => {
  ...
  const handleAddSelectedToInquiry = () => {
    selectedAccessories.forEach(accessoryId => {
      ...
      if (accessory) {
        addToInquiry({
          id: `seiko-mpa40-accessory-${accessory.id}`,
          name: accessory.name,
...
export default function SeikoMPA40ProductPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900">Seiko MP-A40</span>
        </nav>
      </div>
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-justify">
                Seiko MP-A40 to lekka i kompaktowa drukarka mobilna 4-calowa, zaprojektowana z myślą o intensywnej pracy w trudnych warunkach terenowych. Urządzenie charakteryzuje się certyfikatem IP54 oraz odpornością na wielokrotne upadki z wysokości 2 metrów, co czyni je idealnym rozwiązaniem dla pracowników leśnych. Drukarka oferuje szybki druk termiczny o prędkości do 105 mm/s oraz wsparcie dla wielu formatów papieru, w tym etykiet i paragonów. Dzięki łączności USB i Bluetooth oraz kompatybilności z systemami Windows CE, Android i iOS, urządzenie łatwo integruje się z mobilnymi systemami inwentaryzacyjnymi.
              </p>
                ...
                <motion.button
                  onClick={() => {
                    addToInquiry({
                      ...
                      image: '/mpa40_1.png',
                      category: 'Drukarki',
                      description: 'Mobilna drukarka termiczna 4" z certyfikatem IP54',
                      specifications: '203 dpi, 105 mm/s, IP54, USB/Bluetooth, Windows CE/Android/iOS'
                    })
                    setShowRipple(true)
        ...
        {/* Accessories Section */}
        <AccessoriesSection productName="Seiko MP-A40" />
      ...
      <CourierServiceSection productName="Seiko MP-A40" />
