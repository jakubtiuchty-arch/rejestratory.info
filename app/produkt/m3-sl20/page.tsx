...
const Specifications = () => {
  const specs = [
    { category: "Wyświetlacz", items: [
      { name: "Rozmiar", value: "Ekran 8''" },
      { name: "Rozdzielczość", value: "1280 x 800 WXGA" },
    ]},
    { category: "Wydajność", items: [
      { name: "Procesor", value: "Qualcomm MSM8953 Octa-Core 2,2 GHz" },
      { name: "RAM", value: "4GB" },
      { name: "Pamięć", value: "64 GB eMMC" }
    ]},
    { category: "Wytrzymałość", items: [
      { name: "Norma", value: "IP65" },
      { name: "Upadki", value: "Wytrzymuje upadki z 1.5 m" },
      { name: "Temperatura", value: "-20°C do +60°C" }
    ]},
    { category: "Bateria", items: [
      { name: "Pojemność", value: "6300 mAh" },
          ...
          >
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold text-gray-900">Kontrakty serwisowe M3 Mobile</h3>
                <button
                  onClick={onClose}
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Kontrakty serwisowe M3 Mobile to kompleksowe programy wsparcia technicznego, 
...
const AccessoriesSection = ({ productName }: { productName: string }) => {
  ...
  const accessories = [
    ...
    {
      id: 'dock-usb',
      name: 'Stacja dokująca z portem USB + zasilacz + kabel USB',
      description: 'Kompletna stacja dokująca z portem USB'
    },
    {
      id: 'dock-ethernet',
      name: 'Stacja dokująca z portem Ethernet + zasilacz',
      description: 'Stacja dokująca z portem Ethernet'
    },
    {
      id: 'battery-standard',
      name: 'Standardowy akumulator główny 3000mAh',
      description: 'Standardowy akumulator zapasowy'
    },
    {
      id: 'battery-extended',
      name: 'Rozszerzony akumulator główny 5000mAh',
      description: 'Akumulator o zwiększonej pojemności'
    },
    {
      id: 'protective-case',
      name: 'Nakładka na obudowę zabezpieczająca przed uszkodzeniami',
      description: 'Wytrzymała nakładka ochronna na obudowę'
    },
    {
      id: 'wrist-strap',
      name: 'Pasek na rękę',
      description: 'Wygodny pasek zabezpieczający'
    }
  ]
  ...
  const handleAddSelectedToInquiry = () => {
    selectedAccessories.forEach(accessoryId => {
      ...
      if (accessory) {
        addToInquiry({
          id: `m3-sl20-accessory-${accessory.id}`,
          name: accessory.name,
...
export default function M3SL20PlusProductPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900">M3 SL20+</span>
        </nav>
      </div>
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-justify">
                M3 SL20+ to niezawodne urządzenie mobilne stworzone z myślą o wymagających użytkownikach terenowych. Łączy w sobie elegancki design ze wzmocnioną konstrukcją, dzięki czemu doskonale sprawdza się zarówno w biurze, jak i w trudnych warunkach pracy w terenie. Zapewnia płynną obsługę aplikacji biznesowych, długą pracę na baterii oraz wygodny, dotykowy ekran o wysokiej czytelności. Solidne wykonanie i ergonomiczna obudowa gwarantują komfort użytkowania każdego dnia. M3 SL20+ to idealne narzędzie dla tych, którzy potrzebują niezawodności, wydajności i nowoczesności w jednym kompaktowym urządzeniu.
              </p>
                ...
                <motion.button
                  onClick={() => {
                    addToInquiry({
                      ...
                      description: 'Niezawodne urządzenie mobilne dla użytkowników terenowych',
                      specifications: '8" WXGA, Qualcomm MSM8953, 4GB RAM, IP65'
                    })
                    setShowRipple(true)
        ...
        {/* Accessories Section */}
        <AccessoriesSection productName="M3 SL20+" />
      ...
      <CourierServiceSection productName="M3 SL20+" />
