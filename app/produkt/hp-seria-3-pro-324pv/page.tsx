  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-2">
        {[
          { index: 0, src: '/hp_series_2.png' },
          { index: 1, src: '/hp_series_3.png' },
          { index: 2, src: '/hp_series_4.png' }
        ].map((item) => (
          <motion.div
            key={item.index}
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4">
        ...
        {/* Accessories Section */}
        <AccessoriesSection productName="HP Seria 3 Pro 324pv" onAddToInquiry={addToInquiry} />
