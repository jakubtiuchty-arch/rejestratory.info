...
const Specifications = () => {
  const specs = [
    { category: "Wyświetlacz", items: [
      { name: "Rozmiar", value: "6.0 cala" },
      { name: "Rozdzielczość", value: "1280 x 720 HD" },
    ]},
    { category: "Wydajność", items: [
      { name: "Procesor", value: "Qualcomm 660 Octa-core 2.2 GHz" },
      { name: "RAM", value: "6 GB" },
...
const AccessoriesSection = ({ productName }: { productName: string }) => {
  ...
  const accessories = [
    ...
    {
      id: 'dock-usb',
      name: 'Stacja dokująca + port USB + zasilacz + kabel USB',
      description: 'Kompletna stacja dokująca z portem USB'
    },
    {
      id: 'dock-ethernet',
      name: 'Stacja dokująca + port USB + zasilacz + kabel USB + port Ethernet',
      description: 'Stacja dokująca z portem USB i Ethernet'
    },
    {
      id: 'ethernet-module',
    ...
    {
      id: 'battery-standard',
      name: 'Akumulator o standardowej pojemności 3100mAh',
      description: 'Standardowy akumulator zapasowy'
    },
    {
      id: 'battery-extended',
      name: 'Akumulator o powiększonej pojemności 5250mAh',
  ...
  const handleAddSelectedToInquiry = () => {
    selectedAccessories.forEach(accessoryId => {
      ...
      if (accessory) {
        addToInquiry({
          id: `zebra-tc27-accessory-${accessory.id}`,
          name: accessory.name,
...
export default function ZebraTC27ProductPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900">Zebra TC27</span>
        </nav>
      </div>
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-justify">
               Zebra TC27 to nowoczesny, wzmocniony terminal mobilny zaprojektowany z myślą o wymagających zastosowaniach terenowych. 
               Urządzenie łączy poręczność smartfona z niezawodnością sprzętu przemysłowego, umożliwiając płynną pracę zarówno w biurze, jak i w lesie. 
               Wyposażony w wydajny procesor Qualcomm 8-rdzeniowy, system Android 13 z GMS oraz skaner 2D SE4710, 
               TC27 zapewnia szybki odczyt kodów i łatwą integrację z aplikacjami używanymi przez administrację leśną, takimi jak Leśnik+. 
               Certyfikat IP68 i odporność MIL-STD-810H chronią sprzęt przed deszczem, pyłem i upadkami. 
               Bateria 5000 mAh wystarcza na cały dzień pracy, a łączność Wi-Fi 6, Bluetooth 5.2 i LTE zapewnia stały kontakt z bazą danych. 
               TC27 to niezawodne narzędzie dla leśniczego — od inwentaryzacji po ewidencję zasobów terenowych.
              </p>
                ...
                <motion.button
                  onClick={() => {
                    addToInquiry({
                      ...
                      description: 'Wzmocniony terminal mobilny 6" z Android 13 i skanerem 2D',
                      specifications: 'Qualcomm 660 2.2GHz, 6GB RAM, 64GB, 3800mAh, IP68, Wi-Fi 6/BT 5.2/LTE'
                    })
                    setShowRipple(true)
        ...
        {/* Accessories Section */}
        <AccessoriesSection productName="Zebra TC27" />
      ...
      <CourierServiceSection productName="Zebra TC27" />
