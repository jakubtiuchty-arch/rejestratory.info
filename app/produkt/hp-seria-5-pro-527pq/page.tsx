  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-2">
        {[
          { index: 0, src: '/527pq_4.png' },
          { index: 1, src: '/527pq_3.png' },
          { index: 2, src: '/527pq_2.png' }
        ].map((item) => (
          <motion.div
            key={item.index}
        ...
        {isZoomed && (
          ...
          >
            ...
            >
              <img
                src="/527pq_1.png"
                alt="HP Seria 5 QHD - powiększenie"
...
const Specifications = () => {
  const specs = [
    { category: "Wyświetlacz", items: [
      ...
      { name: "Jasność", value: "350 nitów" },
      { name: "Kontrast", value: "1500:1 (statyczny), 10000000:1 (dynamiczny)" },
      { name: "Czas odpowiedzi", value: "5 ms GtG (z Overdrive)" },
      { name: "Gama kolorów", value: "100% sRGB, 16,7 mln kolorów" },
      { name: "Głębia bitowa", value: "True 8 bit" },
      { name: "Obramowanie", value: "Mikrokrawędzie z 3 stron" }
    ]},
    { category: "Łączność", items: [
      { name: "Porty wideo", value: "HDMI 2.0, DisplayPort 1.2" },
      { name: "HDCP", value: "Tak (DisplayPort i HDMI)" },
      { name: "Wyświetlanie częstotliwości", value: "50–100 Hz (pionowo), 30–152 kHz (poziomo)" }
    ]},
    { category: "Ergonomia", items: [
      { name: "Regulacja wysokości", value: "150 mm" },
      { name: "Przechylanie", value: "-5° / +20°" },
      { name: "Obrót w poziomie", value: "±45°" },
      { name: "Pivot", value: "±90°" },
      { name: "Mocowanie VESA", value: "100 × 100 mm" },
      { name: "Waga", value: "6,2 kg (z podstawą), 4,6 kg (bez podstawy)" }
    ]},
    { category: "Dodatkowe funkcje", items: [
      ...
      { name: "Certyfikaty", value: "TCO, EPEAT Gold Climate+, ENERGY STAR" },
          ...
          >
            <div className="p-6">
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  HP Seria 5 QHD jest objęty 3-letnią ograniczoną gwarancją HP na sprzęt. 
...
export default function HPSeria5QHDProductPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <a href="/produkt/hp-seria-5-qhd" className="text-gray-900">HP Seria 5 QHD</a>
        </nav>
      </div>
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-justify">
                HP Seria 5 QHD to profesjonalny monitor 27 cali zaprojektowany z myślą o wymagających użytkownikach biznesowych. Wyróżnia się wysoką rozdzielczością QHD zapewniającą krystalicznie czysty obraz oraz płynnym odświeżaniem 100 Hz, które gwarantuje komfort pracy przez cały dzień. Matryca IPS o jasności 350 nitów i pełnym pokryciu sRGB doskonale sprawdzi się w profesjonalnych zastosowaniach. Ergonomiczna podstawa z pełną regulacją pozwala na idealne dopasowanie monitora do indywidualnych potrzeb. Technologia HP Eye Ease z certyfikatem TÜV oraz eliminacja migotania chronią wzrok podczas długotrwałego użytkowania. Uniwersalne złącza HDMI i DisplayPort zapewniają szeroką kompatybilność. To niezawodne rozwiązanie dla instytucji ceniących jakość obrazu i komfort pracy.
              </p>
              ...
              {/* Odświeżanie 100Hz - pełna szerokość */}
              <div className="mb-6">
                {/* Odświeżanie 100Hz */}
                <div className="bg-gradient-to-br from-blue-600 to-indigo-600 rounded-lg p-4 shadow-md hover:shadow-lg transition-shadow">
                  <div className="flex items-start space-x-3">
                    <Zap className="w-6 h-6 text-white flex-shrink-0 mt-0.5" />
                    <div className="flex-1">
                      <h4 className="font-semibold text-white mb-1">Odświeżanie 100 Hz</h4>
                      <p className="text-sm text-blue-50">
                        Monitor oferuje płynne odświeżanie 100 Hz, zapewniające wyjątkowo komfortową pracę z dokumentami, aplikacjami biurowymi i przeglądarką. Każdy ruch kursora i przewijanie stron są idealnie płynne.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        {/* Accessories Section */}
        {/* <AccessoriesSection productName="HP Seria 5 QHD" onAddToInquiry={addToInquiry} /> */}
      ...
      <CourierServiceSection productName="HP Seria 5 QHD" />
