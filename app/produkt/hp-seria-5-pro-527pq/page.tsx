...
const ImageGallery = ({ images }: { images: string[] }) => {
  ...
  const allImages = ['/527pq_1.png', '/527pq_2.png', '/527pq_3.png', '/527pq_4.png']
                ...
                <motion.button
                  onClick={() => {
                    addToInquiry({
                      ...
                      image: '/527pq_1.png',
                      category: 'Monitory',
                      description: 'Profesjonalny monitor 27" QHD 100Hz',
                      specifications: '27" QHD (2560x1440), IPS, 100Hz, 350 nitów'
                    })
                    setShowRipple(true)
