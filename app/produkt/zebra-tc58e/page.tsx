...
const AccessoriesSection = ({ productName, onAddToInquiry }: { productName: string, onAddToInquiry: (accessory: any) => void }) => {
  ...
  const accessories = [
    ...
    {
      id: 'dock-usb',
      name: 'Stacja dokująca z portami USB + zasilacz + kabel USB z gniazdem ładowania dodatkowej baterii',
      description: 'Kompletna stacja dokująca z gniazdem ładowania baterii'
    },
    {
      id: 'dock-ethernet',
      name: 'Stacja dokująca z portami USB + Ethernet + zasilacz + kabel USB z gniazdem ładowania dodatkowej baterii',
      description: 'Stacja dokująca z USB, Ethernet i gniazdem ładowania baterii'
    },
    {
      id: 'ethernet-module',
    ...
    {
      id: 'battery-standard',
      name: 'Akumulator standardowy min. 4400 mAh',
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900">Zebra TC58E</span>
        </nav>
      </div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-justify">
               Zebra TC58E to flagowy mobilny komputer przemysłowy stworzony dla wymagających warunków pracy w terenie. Idealne rozwiązanie dla leśnictwa i administracji publicznej, łączące zaawansowaną technologię z ekstremalną wytrzymałością. Wyposażony w procesor Qualcomm Snapdragon 660 octa-core, 6GB RAM i Android 11, zapewnia błyskawiczną wydajność przy obsłudze aplikacji terenowych. Ekran 6" Full HD+ z Corning Gorilla Glass gwarantuje doskonałą czytelność w słońcu. Zintegrowany skaner SE55 odczytuje kody z odległości do 12 metrów. Certyfikat IP65/IP68 i MIL-STD-810H oznaczają pełną odporność na wodę, pył i upadki z 1,5m. Bateria 4400mAh z PowerPrecision+ wystarcza na 14h pracy. 5G, Wi-Fi 6E i Bluetooth 5.2 zapewniają najszybszą łączność.
              </p>
                ...
                <motion.button
                  onClick={() => {
                    addToInquiry({
                      ...
                      description: 'Mobilny komputer przemysłowy dla leśnictwa',
                      specifications: 'Qualcomm 660, 6GB RAM, 64GB Flash, IP68'
                    })
                    setShowRipple(true)
      ...
      <CourierServiceSection productName="Zebra TC58E" />
