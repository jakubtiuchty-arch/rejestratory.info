                ...
                <motion.button
                  onClick={() => {
                    addToInquiry({
                      ...
                      image: '/P2425HE_1.png',
                      category: 'Monitory',
                      description: 'Monitor biznesowy 27" z USB-C hub',
