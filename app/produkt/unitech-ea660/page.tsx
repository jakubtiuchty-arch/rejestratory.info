...
const AccessoriesSection = ({ productName }: { productName: string }) => {
  ...
  const handleAddSelectedToInquiry = () => {
    selectedAccessories.forEach(accessoryId => {
      ...
      if (accessory) {
        addToInquiry({
          id: `unitech-ea660-accessory-${accessory.id}`,
          name: accessory.name,
...
export default function UnitechEA660ProductPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900">Unitech EA660</span>
        </nav>
      </div>
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-justify">
                Unitech EA660 to wytrzymały komputer mobilny do pracy leśnika w terenie. 6,0'' ekran FHD+ jest jasny i czytelny w słońcu, a szkło Gorilla Glass chroni przed zarysowaniami. Zintegrowany skaner 2D szybko odczytuje plakietki, kody sztapli i etykiety. Ośmiordzeniowy Snapdragon 2,4 GHz z 6 GB RAM zapewnia płynną obsługę map, zdjęć i formularzy. Klasa IP67 chroni przed deszczem, błotem i kurzem, a wzmocniona obudowa znosi upadki w terenie. Bateria 5000 mAh wystarcza na 16+ godzin pracy, a USB-C przyspiesza ładowanie. Łączność 5G/Wi-Fi 6E zapewnia szybkie wysyłanie danych i stabilne połączenie w słabym zasięgu. NFC ułatwia parowanie akcesoriów, a GPS wspiera orientację w oddziałach i kwaterach. Tryb rękawic i wysoka jasność zwiększają komfort podczas opadów i w pełnym słońcu..
              </p>
                ...
                <motion.button
                  onClick={() => {
                    addToInquiry({
                      ...
                      description: 'Wytrzymały komputer mobilny 6" z IP67 i skanerem 2D',
                      specifications: 'Snapdragon 4490 2.4GHz, 6GB RAM, 128GB, 5000mAh, IP67, 5G/Wi-Fi 6E'
                    })
                    setShowRipple(true)
        ...
        {/* Accessories Section */}
        <AccessoriesSection productName="Unitech EA660" />
      ...
      <CourierServiceSection productName="Unitech EA660" />
