...
const AccessoriesSection = ({ productName }: { productName: string }) => {
  ...
  const handleAddSelectedToInquiry = () => {
    selectedAccessories.forEach(accessoryId => {
      ...
      if (accessory) {
        addToInquiry({
          id: `samsung-xcover7-accessory-${accessory.id}`,
          name: accessory.name,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4">
                ...
                <motion.button
                  onClick={() => {
                    addToInquiry({
                      ...
                      image: '/xcover7_1.png',
                      category: 'Telefony',
                      description: 'Wzmocniony smartfon konsumencki z certyfikatem IP68 i wymienną baterią',
                      specifications: '6.6" Full HD+ TFT LCD, MediaTek Dimensity 6100+, 6GB RAM, IP68, MIL-STD-810H'
                    })
                    setShowRipple(true)
        ...
        {/* Accessories Section */}
        <AccessoriesSection productName="Samsung Galaxy XCover7" />
