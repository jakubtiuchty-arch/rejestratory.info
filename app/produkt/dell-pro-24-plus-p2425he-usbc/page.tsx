  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-2">
        {[
          { index: 0, src: '/P2425HE_2.png' },
          { index: 1, src: '/P2425HE_3.png' },
          { index: 2, src: '/P2425HE_4.png' }
        ].map((item) => (
          <motion.div
            key={item.index}
        ...
        {isZoomed && (
          ...
          >
            ...
            >
              <img
                src="/P2425HE_1.png"
                alt="Dell Pro 24 Plus P2425HE - powiększenie"
...
const Specifications = () => {
  const specs = [
    { category: "Wyświetlacz", items: [
      ...
      { name: "Jasność", value: "250 cd/m², kontrast 1500:1" },
      { name: "Gamut kolorów", value: "99% sRGB" }
    ]},
    { category: "Koncentrator USB-C", items: [
      ...
      { name: "USB Type-A", value: "3 × USB 3.2 downstream" },
      { name: "USB Type-C", value: "1 × USB 3.2 downstream 15W" }
    ]},
    { category: "Łączność i funkcje", items: [
      { name: "Porty wideo", value: "HDMI 1.4, DisplayPort 1.4" },
      { name: "Wyjście DP", value: "DP 1.4 z MST (łączenie szeregowe)" },
      { name: "Dell Power Button Sync", value: "Tak, przez USB-C" },
          ...
          >
            <div className="p-6">
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Dell Pro 24 Plus P2425HE jest objęty 3-letnią ograniczoną gwarancją na sprzęt 
...
export default function DellPro24PlusP2425HEProductPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <a href="/produkt/dell-pro-24-plus-p2425he" className="text-gray-900">Dell Pro 24 Plus P2425HE</a>
        </nav>
      </div>
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-justify">
                Dell Pro 24 Plus P2425HE to zaawansowany monitor biznesowy 23,8 cala ze zintegrowanym koncentratorem USB-C. Jedno złącze USB-C łączy wszystko: ładowanie laptopa do 90W, przesyłanie obrazu DisplayPort 1.4 oraz transfer danych. Wbudowany port Ethernet 1GbE zapewnia stabilne połączenie sieciowe bez dodatkowych kabli. Matryca IPS Full HD z odświeżaniem 100 Hz oraz certyfikat TÜV Eye Comfort 4 gwiazdki gwarantują komfort pracy. Funkcja łączenia szeregowego MST pozwala na podłączenie drugiego monitora przez DisplayPort. Dell Display Manager z EasyArrange oraz Dell Power Button Sync przez USB-C zwiększają produktywność. Monitor objęty 3-letnią gwarancją Premium Panel z wymianą z wyprzedzeniem.
              </p>
              ...
              {/* Koncentrator USB-C - pełna szerokość */}
              <div className="mb-6">
                {/* Koncentrator USB-C */}
                <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-lg p-4 shadow-md hover:shadow-lg transition-shadow">
                  <div className="flex items-start space-x-3">
                    <Usb className="w-6 h-6 text-white flex-shrink-0 mt-0.5" />
                    <div className="flex-1">
                      <h4 className="font-semibold text-white mb-1">Monitor z koncentratorem USB-C</h4>
                      <p className="text-sm text-blue-50">
                        Koncentrator USB-C to rozwiązanie all-in-one: jedno złącze zapewnia ładowanie laptopa (90W), 
                        obraz DisplayPort 1.4 i transfer danych. Wbudowany Ethernet 1GbE oraz dodatkowe porty USB eliminują 
                        konieczność używania osobnego doku - uporządkowana przestrzeń robocza i maksymalna wygoda.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        {/* Accessories Section */}
        <AccessoriesSection productName="Dell Pro 24 Plus P2425HE" onAddToInquiry={addToInquiry} />
      ...
      <CourierServiceSection productName="Dell Pro 24 Plus P2425HE" />
