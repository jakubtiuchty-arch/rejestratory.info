...
const ImageGallery = ({ images }: { images: string[] }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        <img
          src={`/DCPL5510DW_${currentImage + 1}.png?v=2`}
      ...
      <div className="grid grid-cols-3 gap-2">
        {[
          { index: 0, src: '/DCPL5510DW_1.png?v=2' },
          { index: 1, src: '/DCPL5510DW_2.png?v=2' },
          { index: 2, src: '/DCPL5510DW_3.png?v=2' }
        ].map((item) => (
          <motion.div
            key={item.index}
          ...
          >
            <img
              ...
              className={`w-full h-full object-cover object-center ${item.index === 2 ? 'scale-100' : 'scale-90'}`}
            />
          </motion.div>
        ))}
      </div>
        ...
        {isZoomed && (
          ...
          >
            ...
            >
              <img
                src={`/DCPL5510DW_${currentImage + 1}.png?v=2`}
                alt="Brother DCP-L5510DW - powiększenie"
...
const Specifications = () => {
  const specs = [
    ...
    { category: "Obsługa papieru", items: [
      ...
      { name: "ADF", value: "50 arkuszy" }
    ]},
    { category: "Skanowanie i dodatkowe", items: [
      { name: "Typ skanera", value: "CIS" },
      { name: "Rozdzielczość skanowania", value: "Do 1200 x 1200 dpi" },
      { name: "Prędkość skanowania mono", value: "28 ipm" },
      { name: "Prędkość skanowania kolor", value: "20 ipm" },
          ...
          >
            <div className="p-6">
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Urządzenia konsumenckie, takie jak Brother DCP-L5510DW, nie są objęte 
...
export default function BrotherDCPL5510DWProductPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900">Brother DCP-L5510DW</span>
        </nav>
      </div>
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-justify">
                Brother DCP-L5510DW to monochromatyczne urządzenie wielofunkcyjne łączące drukowanie, kopiowanie i skanowanie w kompaktowej obudowie. Technologia laserowa zapewnia szybkie wydruki czarno-białe z prędkością 48 stron na minutę, co czyni je jednym z najszybszych urządzeń w swojej klasie. Automatyczny podajnik dokumentów na 50 arkuszy i funkcja druku dwustronnego usprawniają codzienną pracę biurową. Łączność przewodowa i bezprzewodowa umożliwia łatwą integrację z siecią nadleśnictwa. Kolorowy ekran dotykowy o przekątnej 8,9 cm ułatwia intuicyjną obsługę wszystkich funkcji. Urządzenie zaprojektowane do pracy w warunkach biurowych oferuje zalecany cykl miesięczny do 5000 stron.
              </p>
              <div className="flex space-x-4 mb-6">
                <motion.button
                  onClick={() => {
                    addToInquiry({
                      id: 'brother-dcp-l5510dw',
                      name: 'Brother DCP-L5510DW',
                      image: '/DCPL5510DW_1.png?v=2',
                      category: 'Urządzenia wielofunkcyjne',
                      description: 'Monochromatyczne urządzenie wielofunkcyjne laserowe',
                      specifications: '48 str/min, druk/kopia/skan, automatyczny duplex, Wi-Fi'
                    })
                    setShowRipple(true)
              ...
              {/* Drukarka monochromatyczna - INFO BOX */}
              <div className="bg-gradient-to-r from-slate-100 via-gray-100 to-zinc-100 rounded-lg p-4 border-2 border-slate-300 mb-6 shadow-md">
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-gradient-to-br from-slate-600 to-gray-700 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <Zap className="w-4 h-4 text-white" />
                  </div>
                  <div className="flex-1">
                    <h4 className="font-semibold text-slate-900 mb-1">Drukarka monochromatyczna - bardzo szybka</h4>
                    <p className="text-sm text-gray-800">
                      Urządzenie umożliwia szybkie drukowanie czarno-białe z imponującą prędkością <span className="font-semibold">48 stron na minutę</span>. 
                      Technologia laserowa zapewnia wysoką jakość wydruków tekstowych, idealną do dokumentów biurowych 
                      i materiałów leśnych wymagających szybkiego przetwarzania.
                    </p>
                  </div>
                </div>
              </div>
        ...
        {/* Accessories Section */}
        <AccessoriesSection 
          productName="Brother DCP-L5510DW" 
          onAddToInquiry={(accessory) => {
            addToInquiry({
      ...
      <CourierServiceSection productName="Brother DCP-L5510DW" />
