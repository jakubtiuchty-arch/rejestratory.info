...
const ImageGallery = ({ images }: { images: string[] }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        <img
          src={`/MFCL6710DW_${currentImage + 1}.png?v=2`}
          alt="Brother MFC-L6710DW"
      ...
      <div className="grid grid-cols-3 gap-2">
        {[
          { index: 0, src: '/MFCL6710DW_1.png?v=2' },
          { index: 1, src: '/MFCL6710DW_2.png?v=2' },
          { index: 2, src: '/MFCL6710DW_3.png?v=2' }
        ].map((item) => (
          <motion.div
            key={item.index}
        ...
        {isZoomed && (
          ...
          >
            ...
            >
              <img
                src={`/MFCL6710DW_${currentImage + 1}.png?v=2`}
                alt="Brother MFC-L6710DW - powiększenie"
...
const Specifications = () => {
  const specs = [
    { category: "Ogólne", items: [
      ...
      { name: "Panel sterowania", value: "Kolorowy ekran dotykowy 12,7 cm" }
    ]},
    { category: "Drukowanie", items: [
      { name: "Prędkość druku mono", value: "50 stron/min (A4)" },
      { name: "Druk dwustronny", value: "Automatyczny (24 stron/min)" },
    ...
    { category: "Obsługa papieru", items: [
      ...
      { name: "ADF", value: "70 arkuszy dwustronny" }
    ]},
    { category: "Skanowanie i faksowanie", items: [
      { name: "Skanowanie", value: "Dwustronny CIS, 28 ipm mono jednostronnie" },
          ...
          >
            <div className="p-6">
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Urządzenia konsumenckie, takie jak Brother MFC-L6710DW, nie są objęte 
...
const AccessoriesSection = ({ productName, onAddToInquiry }: { productName: string, onAddToInquiry: (accessory: any) => void }) => {
  ...
  const accessories = [
    {
      id: 'toner-3000',
      name: 'Toner czarny Brother TN-3600',
    ...
    {
      id: 'toner-6000',
      name: 'Toner czarny Brother TN-3600XL',
    ...
    {
      id: 'toner-11000',
      name: 'Toner czarny Brother TN-3600XXL',
...
export default function BrotherMFCL6710DWProductPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900">Brother MFC-L6710DW</span>
        </nav>
      </div>
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-justify">
                Brother MFC-L6710DW to wydajne wielofunkcyjne urządzenie laserowe monochromatyczne zaprojektowane z myślą o intensywnej pracy biurowej. Oferuje profesjonalne możliwości drukowania, kopiowania, skanowania i faksowania z imponującą prędkością 50 stron na minutę. Wyposażone w zaawansowany podajnik ADF na 70 arkuszy oraz automatyczny druk dwustronny, znacząco zwiększa produktywność codziennej pracy. Duży kolorowy ekran dotykowy o przekątnej 12,7 cm zapewnia intuicyjną obsługę wszystkich funkcji. Urządzenie jest w pełni zintegrowane z infrastrukturą sieciową poprzez łączność Gigabit Ethernet oraz Wi-Fi, a funkcje druku mobilnego przez AirPrint i Mopria umożliwiają wygodną pracę z urządzeń mobilnych w dynamicznym środowisku biurowym.
              </p>
              <div className="flex space-x-4 mb-6">
                <motion.button
                  onClick={() => {
                    addToInquiry({
                      id: 'brother-mfc-l6710dw',
                      name: 'Brother MFC-L6710DW',
                      image: '/MFCL6710DW_1.png',
                      category: 'Urządzenia wielofunkcyjne',
                      description: 'Wielofunkcyjne urządzenie laserowe z faksem',
                      specifications: 'Prędkość druku: 50 str/min, ADF 70 ark., Druk/Kopiowanie/Skanowanie/Faks, Wi-Fi'
                    })
                    setShowRipple(true)
              ...
              {/* PRĘDKOŚĆ DRUKU - INFO BOX */}
              <div className="bg-gradient-to-r from-emerald-100 via-green-100 to-teal-100 rounded-lg p-4 border-2 border-emerald-300 mb-6 shadow-md">
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-gradient-to-br from-emerald-600 to-green-600 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <Zap className="w-4 h-4 text-white" />
                  </div>
                  <div className="flex-1">
                    <h4 className="font-semibold text-emerald-900 mb-1">Wysoka prędkość druku</h4>
                    <p className="text-sm text-gray-800">
                      Urządzenie drukuje z prędkością do 50 stron na minutę, zapewniając błyskawiczną 
                      obsługę nawet dużych zadań drukowania. Idealne rozwiązanie dla intensywnie pracujących 
                      biur i zespołów wymagających szybkiego dostępu do dokumentów.
                    </p>
                  </div>
                </div>
              </div>
        ...
        {/* Accessories Section */}
        <AccessoriesSection 
          productName="Brother MFC-L6710DW" 
          onAddToInquiry={(accessory) => {
            addToInquiry({
              id: `accessory-${accessory.id}`,
              name: accessory.name,
              image: accessory.image,
              category: 'Akcesoria - Brother MFC-L6710DW',
      ...
      <CourierServiceSection productName="Brother MFC-L6710DW" />
