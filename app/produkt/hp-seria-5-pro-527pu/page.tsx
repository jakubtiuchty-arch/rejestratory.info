  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-2">
        {[
          { index: 0, src: '/527pu_2.png' },
          { index: 1, src: '/527pu_3.png' },
          { index: 2, src: '/527pu_4.png' }
        ].map((item) => (
          <motion.div
            key={item.index}
  ...
  const accessories = [
    {
      ...
      description: 'Wysokiej jakości kabel USB-C 2m',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4">
        ...
        {/* Accessories Section */}
        <AccessoriesSection productName="HP Seria 5 QHD USB-C" onAddToInquiry={addToInquiry} />
