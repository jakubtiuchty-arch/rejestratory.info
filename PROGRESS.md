...
**Abonament wyjęty z tabeli pozycji (09.09).** Jakub przy ofercie na 10 sztuk: wiersz z abonamentem w tabeli sugerował, że 390 zł miesięcznie wchodzi do sumy zakupu, a to dwa różne rodzaje kosztu (17 990 zł jednorazowo vs 39 zł miesięcznie za urządzenie). Tabela ma teraz tylko pozycje jednorazowe, a abonament razem z prowizjami stoi w bloku **„Opłata miesięczna”** obok podsumowania: kwota za komplet urządzeń, brutto, przelicznik na sztukę i opis, co zawiera. Podsumowanie dostało nagłówek „Zakup urządzeń — jednorazowo” i dopisek „Bez opłat miesięcznych wymienionych obok”. Prowizje wróciły do tego samego boksu, bo osobny trzeci rząd wypychał treść na drugą stronę (sprawdzone dla 1 i 10 sztuk — obie mieszczą się na jednej stronie).
