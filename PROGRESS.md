...
**Dół strony wypełniony (09.09).** Bez uwag zamawiającego oferta kończyła się w połowie strony. Doszedł pasek **„Jak zamówić”** (odpowiedź na ofertę albo telefon, potwierdzenie terminu i dokumenty do fiskalizacji), a drobny druk przeniesiony do stopki, gdzie ma stałe miejsce i nie walczy o resztkę wysokości. Uwagi zamawiającego przesunięte pod tabelę pozycji — w środku strony jest zapas, na dole go nie ma. Pasek pokazuje się tylko przy uwagach krótszych niż 120 znaków: gdy klient napisze dużo, dół jest już wypełniony, a pasek wypchnąłby treść na drugą stronę.
