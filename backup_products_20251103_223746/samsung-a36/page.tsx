...
const Specifications = () => {
  const specs = [
    { category: "Wyświetlacz", items: [
      ...
      { name: "Rozdzielczość", value: "1080 x 2340 Full HD+" },
    ]},
    { category: "Wydajność", items: [
      { name: "Procesor", value: "Exynos 1380 Octa-core" },
      { name: "RAM", value: "6 GB" },
          ...
          >
            <div className="p-6">
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Urządzenia konsumenckie, takie jak Samsung Galaxy A36, nie są objęte 
...
const AccessoriesSection = ({ productName }: { productName: string }) => {
  ...
  const handleAddSelectedToInquiry = () => {
    selectedAccessories.forEach(accessoryId => {
      ...
      if (accessory) {
        addToInquiry({
          id: `samsung-a36-accessory-${accessory.id}`,
          name: accessory.name,
...
export default function SamsungA36ProductPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900">Samsung A36</span>
        </nav>
      </div>
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-justify">
                Samsung Galaxy A36 to smartfon ze średniej półki cenowej dla użytkowników poszukujących podstawowych funkcji w przystępnej cenie. Urządzenie z wyświetlaczem 6.6 cala oferuje standardową jakość obrazu do codziennych zadań. Procesor z 6 GB RAM zapewnia płynność w typowych zastosowaniach biurowych. System Android z usługami Google umożliwia instalację aplikacji administracji leśnej. Bateria 5000 mAh wystarcza na dzień standardowego użytkowania. Certyfikat IP67 zapewnia podstawową ochronę przed pyłem i wilgocią, jednak urządzenie nie jest przeznaczone do intensywnej pracy w trudnych warunkach terenowych. Brak skanera kodów wymaga dodatkowych akcesoriów lub oprogramowania. Samsung A36 może być rozważany jako ekonomiczne rozwiązanie dla zastosowań niewymagających specjalistycznego sprzętu przemysłowego.
              </p>
                ...
                <motion.button
                  onClick={() => {
                    addToInquiry({
                      ...
                      image: '/a36_1.png',
                      category: 'Telefony',
                      description: 'Smartfon konsumencki ze średniej półki cenowej',
                      specifications: '6.6" Full HD+, Exynos 1380, 6GB RAM, IP67'
                    })
                    setShowRipple(true)
        ...
        {/* Accessories Section */}
        <AccessoriesSection productName="Samsung Galaxy A36" />
      ...
      <CourierServiceSection productName="Samsung Galaxy A36" />
