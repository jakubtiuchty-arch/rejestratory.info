        ...
        {isZoomed && (
          ...
          >
            ...
            >
              <img
                src="/r660_1.png"
                alt="Dell PowerEdge R660xs - powiększenie"
...
const Specifications = () => {
  const specs = [
    { category: "Procesor", items: [
      { name: "Model", value: "Intel® Xeon™ Gold-5416S" },
      { name: "Taktowanie", value: "2.0 GHz - 4.0 GHz" },
      { name: "Rdzenie/Wątki", value: "16 rdzeni / 32 wątki" },
      { name: "Cache", value: "30 MB" },
      { name: "TDP", value: "150 W" }
    ]},
    { category: "Pamięć RAM", items: [
      { name: "Pojemność", value: "128 GB (4 x 32 GB)" },
      { name: "Typ", value: "DDR5 RDIMM ECC" },
      { name: "Prędkość", value: "4800 MT/s" }
    ]},
    { category: "Dyski i macierz RAID", items: [
      { name: "Zatoki na dyski", value: "Maksymalnie 8 dysków 2.5″ SAS/SATA (Hot-Plug)" },
      { name: "Kontroler RAID", value: "PERC H755 (Sprzętowy, 8 GB cache, 12 Gb/s)" },
      { name: "Poziomy RAID", value: "0/1/5/6/10/50/60" },
      { name: "Dyski twarde", value: "9,6 TB (4 x 2,4TB HDD, 10000 obr./min, SAS 12 Gb/s, 2.5″, Hot-Plug)" }
    ]},
          ...
          >
            <div className="p-6">
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Dell PowerEdge R660xs jest objęty profesjonalnym wsparciem ProSupport, 
...
export default function DellPowerEdgeR660xsProductPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900">Dell PowerEdge R660xs</span>
        </nav>
      </div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-justify">
                Dell PowerEdge R660xs to wydajny serwer rack 1U z procesorami Intel Xeon Gold czwartej generacji, 
                zaprojektowany dla wymagających nadleśnictw potrzebujących maksymalnej mocy obliczeniowej w kompaktowej 
                obudowie. Procesor Gold z 16 rdzeniami i pamięć DDR5 4800 MT/s zapewniają wyjątkową wydajność dla 
                najbardziej złożonych aplikacji leśnych i analiz danych. Szybkie dyski SAS 10000 obr./min gwarantują 
                błyskawiczny dostęp do danych. System zarządzania iDRAC9 Enterprise oraz redundantne zasilacze Hot-Plug 
                zapewniają najwyższą niezawodność dla krytycznych systemów nadleśnictwa.
              </p>
              ...
              <div className="flex space-x-4 mb-6">
                <motion.button
                  onClick={() => {
                    addToInquiry({
                      id: 'dell-poweredge-r660xs',
                      name: 'Dell PowerEdge R660xs',
                      image: '/r660_1.png',
                      category: 'Serwery',
                      description: 'Wydajny serwer rack 1U z Intel Xeon Gold',
                      specifications: 'Intel Xeon Gold-5416S, 128GB DDR5, 9.6TB RAID'
                    })
                    setShowRipple(true)
              ...
              {/* BOX 1 - RAM i HDD - czerwono-pomarańczowy gradient */}
              <div className="rounded-lg p-4 border-2 mb-4 shadow-md" style={{ background: 'linear-gradient(to right, #dc2626, #ea580c, #fb923c)', borderColor: '#ea580c' }}>
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold mb-1 text-white">Maksymalna wydajność pamięci i dysków</h4>
                    <p className="text-sm text-white">
                      Serwer wyposażony w 128 GB pamięci RAM DDR5 RDIMM ECC 4800 MT/s oraz 9,6 TB przestrzeni dyskowej 
                      (4 x 2,4TB HDD 10000 obr./min SAS w macierzy RAID). Najnowsza pamięć DDR5 oraz szybkie dyski 
                      SAS zapewniają najwyższą wydajność do obsługi najbardziej wymagających systemów leśnych, 
                      zaawansowanych analiz danych oraz aplikacji czasu rzeczywistego.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-white">
                      ...
                      Możliwa jest rozbudowa pamięci RAM DDR5, dodanie większej ilości dysków twardych (do 8 zatoki 2.5″), 
                      wymiana kontrolera RAID na wydajniejszy oraz instalacja dodatkowych kart 
                      rozszerzeń. Kompaktowa konstrukcja 1U z procesorem Gold pozwala na maksymalne 
                      wykorzystanie mocy obliczeniowej bez kompromisów w zakresie możliwości rozbudowy.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <CourierServiceSection productName="Dell PowerEdge R660xs" />
