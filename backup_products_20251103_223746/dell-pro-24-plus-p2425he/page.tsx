        ...
        {isZoomed && (
          ...
          >
            ...
            >
              <img
                src={allImages[currentImage]}
                alt="Dell Pro 24 Plus P2425H - powiększenie"
                className="object-contain"
...
const Specifications = () => {
  const specs = [
    ...
    { category: "Łączność", items: [
      { name: "Porty wideo", value: "HDMI 1.4, DisplayPort 1.2, VGA" },
      { name: "USB Type-C", value: "Power Delivery do 15 W" },
      { name: "USB Type-A", value: "3 × USB 3.2 pierwszej generacji" },
      { name: "USB Type-B", value: "1 × USB 3.2 upstream" }
    ]},
          ...
          >
            <div className="p-6">
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Dell Pro 24 Plus P2425H jest objęty 3-letnią ograniczoną gwarancją na sprzęt 
...
export default function DellPro24PlusP2425HProductPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <a href="/produkt/dell-pro-24-plus-p2425h" className="text-gray-900">Dell Pro 24 Plus P2425H</a>
        </nav>
      </div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-justify">
                Dell Pro 24 Plus P2425H to uniwersalny monitor biznesowy 23,8 cala zaprojektowany dla profesjonalistów. Matryca IPS Full HD z odświeżaniem 100 Hz zapewnia płynny obraz podczas codziennej pracy biurowej. Technologia TÜV Eye Comfort z certyfikatem 4 gwiazdek i funkcja eliminacji migotania chronią wzrok podczas długich godzin pracy. Ergonomiczna podstawa umożliwia regulację wysokości, przechylanie oraz obrót monitora w poziomie i pionie. Dell Display Manager z funkcją EasyArrange pozwala na sprawne zarządzanie oknami aplikacji. Port USB-C z Power Delivery 15W oraz pełen zestaw portów HDMI, DisplayPort i VGA zapewniają kompatybilność z dowolnym sprzętem. Monitor objęty 3-letnią gwarancją Premium Panel.
              </p>
              <div className="flex space-x-4 mb-6">
                <motion.button
                  onClick={() => {
                    addToInquiry({
                      id: 'dell-pro-24-plus-p2425h',
                      name: 'Dell Pro 24 Plus P2425H',
                      image: '/P2425HE_1.png',
                      category: 'Monitory',
                      description: 'Monitor biznesowy 23,8" Full HD IPS',
                      specifications: 'FHD IPS, 100Hz, USB-C 15W, 3-letnia gwarancja Premium Panel'
                    })
                    setShowRipple(true)
              ...
              {/* Najpopularniejszy monitor - pełna szerokość */}
              <div className="mb-6">
                {/* Najpopularniejszy monitor */}
                <div className="bg-gradient-to-br from-slate-700 to-gray-800 rounded-lg p-4 shadow-md hover:shadow-lg transition-shadow">
                  <div className="flex items-start space-x-3">
                    <Award className="w-6 h-6 text-white flex-shrink-0 mt-0.5" />
                    <div className="flex-1">
                      <h4 className="font-semibold text-white mb-1">Najczęściej wybierany monitor</h4>
                      <p className="text-sm text-slate-100">
                        Dell Pro 24 Plus P2425H to najpopularniejszy wybór do codziennej pracy biurowej. 
                        Sprawdzone rozwiązanie dla profesjonalistów w administracji publicznej.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <CourierServiceSection productName="Dell Pro 24 Plus P2425H" />
