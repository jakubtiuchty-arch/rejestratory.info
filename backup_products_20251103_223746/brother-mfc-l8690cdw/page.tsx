...
const ImageGallery = ({ images }: { images: string[] }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        <img
          src={`/MFCL8690CDW_${currentImage + 1}.png?v=2`}
      ...
      <div className="grid grid-cols-3 gap-2">
        {[
          { index: 0, src: '/MFCL8690CDW_1.png?v=2' },
          { index: 1, src: '/MFCL8690CDW_2.png?v=2' },
          { index: 2, src: '/MFCL8690CDW_3.png?v=2' }
        ].map((item) => (
          <motion.div
            key={item.index}
        ...
        {isZoomed && (
          ...
          >
            ...
            >
              <img
                src={`/MFCL8690CDW_${currentImage + 1}.png?v=2`}
                alt="Brother MFC-L8690CDW - powiększenie"
...
const Specifications = () => {
  const specs = [
    ...
    { category: "Funkcje dodatkowe", items: [
      ...
      { name: "Cykl pracy", value: "Do 3000 stron miesięcznie" },
          ...
          >
            <div className="p-6">
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Urządzenia konsumenckie, takie jak Brother MFC-L8690CDW, nie są objęte 
...
const AccessoriesSection = ({ productName, onAddToInquiry }: { productName: string, onAddToInquiry: (accessory: any) => void }) => {
  ...
  const accessories = [
    {
      id: 'toner-black',
      name: 'Toner czarny (BK)',
      description: 'Oryginalny toner Brother, wydajność 3000 stron',
      image: '/MFCL8690CDW_toner_czarny.png',
      price: 'Zapytaj o cenę'
    },
    {
      id: 'toner-cyan',
      name: 'Toner cyan',
      description: 'Oryginalny toner Brother, wydajność 1800 stron',
      image: '/MFCL8690CDW_toner_cyan.png',
      price: 'Zapytaj o cenę'
    },
    {
      id: 'toner-magenta',
      name: 'Toner magenta',
      description: 'Oryginalny toner Brother, wydajność 1800 stron',
      image: '/MFCL8690CDW_toner_magenta.png',
      price: 'Zapytaj o cenę'
    },
    {
      id: 'toner-yellow',
      name: 'Toner żółty',
      description: 'Oryginalny toner Brother, wydajność 1800 stron',
      image: '/MFCL8690CDW_toner_żólty.png',
      price: 'Zapytaj o cenę'
    }
  ]
...
export default function BrotherMFCL8690CDWProductPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900">Brother MFC-L8690CDW</span>
        </nav>
      </div>
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-justify">
                Brother MFC-L8690CDW to wielofunkcyjne urządzenie laserowe łączące drukowanie, kopiowanie, skanowanie i faksowanie w jednej obudowie. Technologia laserowa zapewnia wydruki kolorowe i monochromatyczne z prędkością 31 stron na minutę, co sprawia się w typowych zastosowaniach biurowych. Wyposażenie w automatyczny podajnik dokumentów i funkcję druku dwustronnego usprawnia codzienną pracę. Łączność przewodowa i bezprzewodowa umożliwia integrację z infrastrukturą sieciową nadleśnictwa. Ekran dotykowy ułatwia obsługę podstawowych funkcji. Urządzenie przeznaczone jest do pracy w kontrolowanych warunkach biurowych. Cykl miesięczny do 3000 stron określa zalecane obciążenie, które wystarcza dla mniejszych jednostek. Brother MFC-L8690CDW oferuje standardowe możliwości urządzeń klasy biurowej w przystępnej cenie, z ograniczeniami charakterystycznymi dla sprzętu niezaprojektowanego pod intensywną eksploatację w zmiennych warunkach.
              </p>
                ...
                <motion.button
                  onClick={() => {
                    addToInquiry({
                      ...
                      image: '/MFCL8690CDW_1.png?v=2',
                      category: 'Urządzenia wielofunkcyjne',
                      description: 'Wielofunkcyjne urządzenie laserowe kolorowe',
                      specifications: '31 str/min kolor/mono, ADF 50 ark., Wi-Fi, druk dwustronny, 512MB RAM'
                    })
                    setShowRipple(true)
              ...
              {/* Drukarka kolorowa - INFO BOX */}
              <div className="bg-gradient-to-r from-purple-100 via-pink-100 to-orange-100 rounded-lg p-4 border-2 border-purple-300 mb-6 shadow-md">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-purple-900 mb-1">Drukarka kolorowa</h4>
                    <p className="text-sm text-gray-800">
                      Urządzenie umożliwia drukowanie w pełnym kolorze z prędkością 31 stron na minutę. 
                      Technologia laserowa zapewnia wysoką jakość wydruków kolorowych dokumentów, 
                      prezentacji i materiałów graficznych.
                    </p>
                  </div>
                </div>
              </div>
        ...
        {/* Accessories Section */}
        <AccessoriesSection 
          productName="Brother MFC-L8690CDW" 
          onAddToInquiry={(accessory) => {
            addToInquiry({
              id: `brother-mfc-l8690cdw-accessory-${accessory.id}`,
              name: accessory.name,
      ...
      <CourierServiceSection productName="Brother MFC-L8690CDW" />
